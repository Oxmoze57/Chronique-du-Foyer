...
const roomAssets={
  'Cuisine':'assets/room-cuisine.webp','Salon':'assets/room-salon.webp','Chambre adulte':'assets/room-chambre-adulte.webp','Chambre enfant':'assets/room-chambre-enfant.webp','Salle de bain':'assets/room-salle-de-bain.webp','WC':'assets/room-wc.webp','Terrasse':'assets/room-terrasse.webp','Cave':'assets/room-cave.webp'
};
const roomAsset=room=>roomAssets[room]||'';
const ranks=[
...
const guardianStages=[
  ...
  {min:60,max:69,img:'assets/guardian-stage-60.webp',name:'Le Seigneur Bâtisseur',gear:'Armure noble, manteau long, marteau cérémoniel',decor:'Royaume en construction, tours et ateliers',desc:'Tu bâtis désormais au-delà de l’entretien quotidien.'},
  {min:70,max:79,img:'assets/guardian-stage-70.webp',name:'Le Gardien Ascendant',gear:'Armure noire et or raffinée, runes éveillées',decor:'Royaume achevé, temples et crépuscule doré',desc:'Tes habitudes deviennent une puissance visible.'},
  {min:80,max:89,img:'assets/guardian-stage-80.webp',name:'Le Gardien Légendaire',gear:'Armure légendaire, cape majestueuse, halo runique',decor:'Royaume vu depuis les hauteurs',desc:'Ton foyer porte la trace durable de ta constance.'},
  {min:90,max:99,img:'assets/guardian-stage-90.webp',name:'Le Demi-Dieu du Foyer',gear:'Armure mythologique noire, or et ivoire, reliques orbitantes',decor:'Cité mythologique sous un ciel étoilé',desc:'Le Gardien devient le symbole vivant du Royaume.'},
  {min:100,max:9999,img:'assets/guardian-stage-100.webp',name:'Le Gardien Éternel',gear:'Armure ultime, Flamme Éternelle, Cercle du Gardien',decor:'Royaume entier au lever du soleil, maison originelle au centre',desc:'Tu n’as pas construit une série : tu as construit un héritage.'}
];
