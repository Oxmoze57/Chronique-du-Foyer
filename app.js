...
function freshState(){return{schemaVersion:7,tasks:defaultTasks,projects:defaultProjects,xp:0,shards:0,activeDays:[],oath:[],oathDate:dateKey(),oathsByDate:{},pathFilter:'all',virtues:{Foyer:0,Artisanat:0,Soutien:0,Discipline:0},ritualTime:'21:30',lastRitualNotice:'',week:{key:weekKey(),count:0},achievements:[],stats:{missions:0,minutes:0,oaths:0,rescues:0}}}
...
const guardianStages=[
  {min:1,max:9,img:'assets/guardian-stage-1.webp',name:'Débutant',desc:'Des vêtements simples. La volonté avant l’armure.'},
  {min:10,max:19,img:'assets/guardian-stage-10.webp',name:'Vainqueur',desc:'Les premiers équipements témoignent de ta constance.'},
  {min:20,max:29,img:'assets/guardian-stage-20.webp',name:'Protecteur',desc:'Une véritable armure apparaît : ton foyer sent ta présence.'},
  {min:30,max:39,img:'assets/guardian-stage-30.webp',name:'Gardien',desc:'Ton armure s’affirme. Tu ne subis plus le désordre : tu le maîtrises.'},
  {min:40,max:49,img:'assets/guardian-stage-40.webp',name:'Champion',desc:'Une armure lourde, forgée par des centaines de gestes utiles.'},
  {min:50,max:9999,img:'assets/guardian-stage-50.webp',name:'Mythe',desc:'Le Gardien accompli. La discipline est devenue une seconde nature.'}
];
function guardianStage(){const l=level();return guardianStages.find(s=>l>=s.min&&l<=s.max)||guardianStages.at(-1)}
